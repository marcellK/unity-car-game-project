...
/**
 * Move forward button, accepts messages from SensorMovePlayer
...
{  
    ...
    void OnTouchDown()
    {
        /*
         ...
         is 1.0, when we turn left (the axis is given as a cross product)
        ...
        */
        ...
        playerCar.GetComponent<Rigidbody2D>().AddForce(
            carFront.normalized * PlayerCarAttributes.power * PlayerCarAttributes.currentDirectionTilt);
